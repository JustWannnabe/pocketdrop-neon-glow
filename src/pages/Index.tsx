  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative flex flex-col items-center justify-center text-center min-h-[70vh] px-6 pt-24 pb-8 overflow-hidden">
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 w-full max-w-sm relative z-10">
          <Link to="/send" className="flex items-center justify-center text-center px-4 py-3 min-h-[3.5rem] rounded-lg font-display font-bold text-sm tracking-wider border border-primary bg-primary text-primary-foreground neon-box-cyan hover:brightness-110 transition-all">
            Send a File
          </Link>
          <Link to="/get" className="flex items-center justify-center text-center px-4 py-3 min-h-[3.5rem] rounded-lg font-display font-bold text-sm tracking-wider border border-accent text-accent neon-text-purple hover:bg-accent/10 transition-all">
            Receive a File
          </Link>
        </div>
      </section>
